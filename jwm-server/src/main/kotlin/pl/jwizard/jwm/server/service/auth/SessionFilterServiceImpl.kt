...
class SessionFilterServiceImpl(
	...
	override fun getUserSession(sessionId: ByteArray) = sessionSupplier.getSession(sessionId)

	override fun updateSessionTime(sessionId: ByteArray, now: LocalDateTime): Int {
	...
	override fun deleteExpiredSession(sessionId: ByteArray, userId: Long) {
